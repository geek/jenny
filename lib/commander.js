...
internals.Commander.prototype.register = function (command, callback) {

    var stringified = JSON.stringify(command);
    Wreck.post(this._url + '/radio', { payload: stringified, headers: internals.headers }, callback);
};
...
internals.Commander.prototype.report = function (command, callback) {
    ...
    var stringified = JSON.stringify(command);
    Wreck.put(this._url + '/radio/' + command.id, { payload: stringified, headers: internals.headers }, callback);
};
