...
internals.Commander.prototype.updateBoard = function (boardId, data, callback) {

    var stringified = JSON.stringify(data);
    Wreck.put(this._url + '/board/' + boardId, { payload: stringified, headers: internals.headers }, function (err, res, payload) {
...
internals.Commander.prototype.updateAddon = function (boardId, addonId, data, callback) {

    var stringified = JSON.stringify(data);
    Wreck.put(this._url + '/board/' + boardId + '/' + addonId, { payload: stringified, headers: internals.headers }, function (err, res, payload) {
...
internals.Commander.prototype.createReading = function (boardId, addonId, data, callback) {

    var stringified = JSON.stringify(data);
    Wreck.post(this._url + '/board/' + boardId + '/' + addonId + '/reading', { payload: stringified, headers: internals.headers }, function (err, res, payload) {
